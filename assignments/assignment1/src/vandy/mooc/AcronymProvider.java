...
public class AcronymProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri,
        ...
        case ACRONYMS:
            ...
            long id = db.insert(AcronymContract.AcronymEntry.CONTENT_ITEMS_TYPE, "", values);
        ...
        case ACRONYMS:
            ...
            try {
                ...
                for (ContentValues value: contentValues){
                    final long id =
                            db.insert(AcronymContract.AcronymEntry.CONTENT_ITEMS_TYPE,
                                    null,
                                    value);
                    if (id != -1)
                        returnCount++;
    ...
    public Cursor query(Uri uri,
        ...
        case ACRONYMS: 
            ...
            // into the method.
            queryBuilder.setTables(AcronymContract.AcronymEntry.CONTENT_ITEMS_TYPE);
            retCursor = queryBuilder.query(mOpenHelper.getWritableDatabase(),
                    projection,
                    selection,
                    selectionArgs,
                    null,
        ...
        case ACRONYM: 
            ...
            queryBuilder.setTables(AcronymContract.AcronymEntry.CONTENT_ITEM_TYPE);
            retCursor = queryBuilder.query(mOpenHelper.getWritableDatabase(),
                    projection,
                    rowId,
                    selectionArgs,
    ...
    public int update(Uri uri,
        ...
        case ACRONYMS:
            ...
            rowsUpdated = db.update(AcronymContract.AcronymEntry.CONTENT_ITEMS_TYPE,
    ...
    public int delete(Uri uri,
        ...
        case ACRONYMS:
            ...
            rowsDeleted = db.delete(AcronymContract.AcronymEntry.CONTENT_ITEMS_TYPE,
