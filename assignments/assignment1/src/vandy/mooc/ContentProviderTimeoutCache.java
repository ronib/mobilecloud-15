...
import vandy.mooc.provider.cache.DeleteCacheReceiver;
import vandy.mooc.provider.cache.TimeoutCache;
...
public class ContentProviderTimeoutCache
    ...
    public List<AcronymExpansion> get(final String acronym) {
        ...
        try (Cursor cursor =
            ...
            // from first row and add it to the List.
                ...
                Long expirationTime = mDefaultTimeout;// 0L;
    ...
    public void remove(String acronym) {
        ...
        mContext.getContentResolver().delete(AcronymEntry.CONTENT_URI, AcronymEntry.COLUMN_ACRONYM,
                selectionArgs);
